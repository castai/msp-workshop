...
6. **Save the node template**

   Click **Save** to apply the template changes.

   ![edit node template](./images/edit-node-template.png)
   ![edit node template](./images/edit-node-template-2.png)
...
8. **Simulate a sudden traffic spike**
